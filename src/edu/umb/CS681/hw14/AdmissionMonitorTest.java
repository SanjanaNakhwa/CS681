...
//             handlers[i] = monitor.new EntranceHandler(monitor);
...
//             handlers[i - handlers.length] = monitor.new ExitHandler(monitor);
...
//             handlers[i - handlers.length * 2] = monitor.new StatsHandler(monitor);
