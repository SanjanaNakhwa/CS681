...
public class CensusDataProcessorHw20 {
    public static void main(String[] args) {
        
        try {
            List<List<String>> csv = Files.lines(Paths.get("/Users/sanjananakhwa/Documents/OOPS/CS681Hws/src/edu/umb/CS681/hw20/census_data.csv"))
            .map( line -> {
            ...
            List<List<String>> chasBlocks = lines.stream()
             ...
             double chasAvgPrice = chasBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(13))).average().orElse(0);
             double chasMinPrice = chasBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(13))).min().orElse(0);
             double chasMaxPrice = chasBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(13))).max().orElse(0);
            ...
            double commonAvgPrice = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(13))).average().orElse(0);
            double commonMinPrice = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(13))).min().orElse(0);
            double commonMaxPrice = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(13))).max().orElse(0);
            ...
            double commonAvgNox = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(4))).average().orElse(0);
            double commonMinNox = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(4))).min().orElse(0);
            double commonMaxNox = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(4))).max().orElse(0);
            ...
            double commonAvgRooms = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(5))).average().orElse(0);
            double commonMinRooms = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(5))).min().orElse(0);
            double commonMaxRooms = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(5))).max().orElse(0);
            ...
            System.out.println("Maximum Rooms: " + commonMaxRooms);
             ...
             double chasAvgAge = chasBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(6))).average().orElse(0);
             double chasMinAge = chasBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(6))).min().orElse(0);
             double chasMaxAge = chasBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(6))).max().orElse(0);
             ...
             double commonAvgTaxRatio = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(9))).average().orElse(0);
             double commonMinTaxRatio = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(9))).min().orElse(0);
             double commonMaxTaxRatio = commonBlocks.stream().parallel().mapToDouble(block -> Double.parseDouble(block.get(9))).max().orElse(0);
